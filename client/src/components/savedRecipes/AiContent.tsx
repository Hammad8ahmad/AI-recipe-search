        ...
        <div>
          {NutritionAnalysis && activeFeature === "analysis" &&  (
            <>
              ...
              <h4 className="text-2xl mt-4 font-semibold  mb-2">Minerals</h4>
              <ul className="list-disc   text-lg ">
              {NutritionAnalysis.micronutrients.minerals.map((item:any) => {
                return <li className="font-bold text-amber-300">{item}</li>
              })}</ul>
              <h3 className="text-2xl mt-4 font-semibold mb-2">Vitamins</h3>
              <ul className="list-disc  text-lg ">
          ...
          {recipeOptimization && activeFeature === "optimization" && (
            <>
              ...
              <ol className="text-lg list-decimal text-left ">
          ...
          {recipeInstructions && activeFeature === "instructions" && (
            <>
              ...
              <h4 className="text-2xl mt-4">Time Estimate: <span>{recipeInstructions.time_estimate}</span> </h4>
            </>
          )}
